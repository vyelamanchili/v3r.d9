...
<form action="<?php echo JRoute::_('index.php?option=com_maximenuck&view=menubuilders' . $appendUrl); ?>" method="post" name="adminForm" id="adminForm">
	<?php if ($isModal) { ?>
	<div id="ckheader">
		...
		<div class="ckheadermenu">
			<div class="ckheadertitle"><span class="ckheadertitleupper">Maximenu CK</span> - <?php echo JText::_('COM_MAXIMENUCK_MENU_BUILDERS'); ?></div>
		</div>
	</div>
