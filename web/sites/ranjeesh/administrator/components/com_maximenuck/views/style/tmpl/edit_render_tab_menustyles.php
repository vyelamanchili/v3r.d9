...
<div class="ckrow">
	...
	<div class="ckbutton-group">
		...
		</label><input class="level1itemnormalstyles" type="radio" value="default" id="level1itemnormalstylestexttransformdefault" name="level1itemnormalstylestexttransform" />
