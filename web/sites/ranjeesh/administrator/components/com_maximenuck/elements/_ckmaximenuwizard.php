...
<?php
	...
	protected function getInput() {
		...
		$this->imagesPath = JUri::root() . 'media/com_maximenuck/elements/ckmaximenuwizard/';
...
// var_dump($form);die;
		...
		JHtml::_('script', MAXIMENUCK_MEDIA_URI . '/images/'  . 'ckmaximenuwizard.js');
		JHtml::_('stylesheet', MAXIMENUCK_MEDIA_URI . '/images/'  . 'ckmaximenuwizard.css');
