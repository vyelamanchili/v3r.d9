    ...
    UI.component('pagination', {
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-cw-pagination]', context).each(function(){
                    var ele = UI.$(this);

                    if (!ele.data('pagination')) {
                        UI.pagination(ele, UI.Utils.options(ele.attr('data-cw-pagination')));
                    }
                });
            });
        },
        ...
        _append: function(pageIndex, opts) {
            ...
            item = (pageIndex == this.currentPage) ? '<li class="cw-active"><span>' + (options.text) + '</span></li>' : '<li><a href="#page-'+(pageIndex+1)+'" data-page="'+pageIndex+'">'+options.text+'</a></li>';
