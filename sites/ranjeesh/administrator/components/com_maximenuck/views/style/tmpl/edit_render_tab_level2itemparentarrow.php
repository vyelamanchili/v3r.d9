...
<div class="ckrow">
	...
	<div class="ckbutton-group">
		...
		<a class="modal ckbutton" href="<?php echo JUri::base(true) ?>/index.php?option=com_maximenuck&view=browse&tmpl=component&field=level2itemnormalstylesparentitemimage" rel="{handler: 'iframe'}" ><?php echo JText::_('CK_SELECT'); ?></a>
