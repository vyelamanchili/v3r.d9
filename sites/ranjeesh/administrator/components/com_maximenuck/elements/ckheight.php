...
class JFormFieldCkheight extends CKFormField {
	...
	protected function getInput() {
		...
		$html .= '<div id="ckheightfieldhelp" style="display: none;"><h3>' . JText::_('MAXIMENUCK_HEIGHT_FIELD_HELP_TITLE') . '</h3>
		<p>' . JText::_('MAXIMENUCK_HEIGHT_FIELD_HELP_1') . '</p>
		<p><b>' . JText::_('MAXIMENUCK_HEIGHT_FIELD_HELP_2') . '</b></p>
		<p>' . JText::_('MAXIMENUCK_HEIGHT_FIELD_HELP_3') . '</p>
		<p>' . JText::_('MAXIMENUCK_HEIGHT_FIELD_HELP_4') . '</p>
		<p style="text-align:center;padding:10px;font-size: 18px;">1280 x 800 px</p>
		<p>' . JText::_('MAXIMENUCK_HEIGHT_FIELD_HELP_5') . '</p>
		<p><b>' . JText::_('MAXIMENUCK_CALCULATOR') . '</b></p>
		<p><label for="ckheightfieldhelpheight">' . JText::_('MAXIMENUCK_HEIGHT_LABEL') . '</label><input type="text" id="ckheightfieldhelpheight" onchange="ckHeightFieldHelpCalculator()"/></p>
		<p><label for="ckheightfieldhelpwidth">' . JText::_('MAXIMENUCK_WIDTH_LABEL') . '</label><input type="text" id="ckheightfieldhelpwidth" onchange="ckHeightFieldHelpCalculator()" /></p>
		<p><label for="ckheightfieldhelpratio">' . JText::_('MAXIMENUCK_RATIO_LABEL') . '</label><input type="text" id="ckheightfieldhelpratio" style="font-size: 18px;" /></p>
