...
(function(addon) {
    ...
    UI.component('nestable', {
        ...
        defaults: {
            listBaseClass   : 'cw-nestable',
            listClass       : 'cw-nestable-list',
            listItemClass   : 'cw-nestable-item',
            dragClass       : 'cw-nestable-dragged',
            movingClass     : 'cw-nestable-moving',
            noChildrenClass : 'cw-nestable-nochildren',
            emptyClass      : 'cw-nestable-empty',
            handleClass     : '',
            collapsedClass  : 'cw-collapsed',
            placeholderClass: 'cw-nestable-placeholder',
            noDragClass     : 'cw-nestable-nodrag',
            group           : false,
            maxDepth        : 10,
            threshold       : 20,
            idlethreshold   : 10,
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$("[data-cw-nestable]", context).each(function(){

                    var ele = UI.$(this);

                    if (!ele.data("nestable")) {
                        UI.nestable(ele, UI.Utils.options(ele.attr("data-cw-nestable")));
                    }
                });
            });
        },
        ...
        setParent: function(li) {
            ...
            if (li.children(this.options._listClass).length) {
                li.addClass("cw-parent");
            }
        },

        unsetParent: function(li) {
            li.removeClass('cw-parent '+this.options.collapsedClass);
