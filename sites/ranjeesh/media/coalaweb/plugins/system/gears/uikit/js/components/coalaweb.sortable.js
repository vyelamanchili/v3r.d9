...
(function(addon) {
    ...
    UI.component('sortable', {
        ...
        defaults: {
            ...
            childClass       : 'cw-sortable-item',
            placeholderClass : 'cw-sortable-placeholder',
            overClass        : 'cw-sortable-over',
            draggingClass    : 'cw-sortable-dragged',
            dragMovingClass  : 'cw-sortable-moving',
            baseClass        : 'cw-sortable',
            noDragClass      : 'cw-sortable-nodrag',
            emptyClass       : 'cw-sortable-empty',
            dragCustomClass  : '',
            handleClass      : false,
            group            : false,
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$("[data-cw-sortable]", context).each(function(){

                    var ele = UI.$(this);

                    if(!ele.data("sortable")) {
                        UI.sortable(ele, UI.Utils.options(ele.attr("data-cw-sortable")));
                    }
                });
            });
