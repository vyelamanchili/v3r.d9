...
(function(addon) {
    ...
    UI.component('sticky', {
        ...
        init: function() {
            ...
            var wrapper  = UI.$('<div class="cw-sticky-placeholder"></div>'), boundary = this.options.boundary, boundtoparent;
            ...
            this.sticky = {
                ...
                reset: function(force) {
                    ...
                    if (!force && this.options.animation && UI.support.animation && !UI.Utils.isInView(this.wrapper)) {
                        ...
                        this.element.addClass(this.options.animation+' '+'cw-animation-reverse');
                    } else {
                        finalize();
                    }
                },
